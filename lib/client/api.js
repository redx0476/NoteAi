...
export const MODELS = [
  { id: 'nvidia/nemotron-3-super-120b-a12b:free', label: 'Nemotron 3 Super — 1M context, best for long meetings' },
  { id: 'openai/gpt-oss-120b:free', label: 'GPT-OSS 120B — best free quality' },
  { id: 'google/gemma-4-31b-it:free', label: 'Gemma 4 31B — fast, 256K context' },
  { id: 'nvidia/nemotron-3-ultra-550b-a55b:free', label: 'Nemotron 3 Ultra — highest quality, slower' },
